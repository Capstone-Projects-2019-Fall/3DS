#This is a modified version of the ADXL345 
#It captures  the data from the accelerometor  axis and send to the rasberry Pi 
# ADXL345
# This code is designed to work with the ADXL345_I2CS I2C Mini Module 
